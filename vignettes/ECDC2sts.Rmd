...
animate(ecdc_sts, tps = 49:96, sleep = 0, verbose = FALSE) # see help("animate.sts") for options
```
...
## Select 10 groups based on the quantiles of the incidence distribution
breaks <- quantile(1e6 * observed(ecdc_sts) / population(ecdc_sts),
                   probs = seq(0,1,length=20), na.rm = TRUE)
