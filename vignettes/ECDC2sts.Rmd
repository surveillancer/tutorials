...
plot(ecdc_sts, type = observed ~ time | unit, units = topcounts6)
```
...
local({
    ...
    plot(ecdc_sts, type = observed ~ time | unit, units = topcounts6, ylab = "Incidence (per 1'000'000)")
})
```
...
plot(ecdc_sts, type = observed ~ unit, population = 1000000/9,
...
animate(ecdc_sts, tps = 49:96, sleep = 0, verbose = FALSE,
        timeplot = list(as.Date = TRUE),
        population = 1000000)  # -> incidence per 1'000'000 inhabitants
```
