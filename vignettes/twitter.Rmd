...
ggplot(ts2, aes(x=time, y=n)) + geom_bar(stat="identity",alpha=.8) + theme(axis.text.x=element_text(angle=90, hjust=1)) + ylab("No. of tweets") + xlab("Time") + ggtitle(the_query) + scale_x_datetime(date_minor_breaks="1 hour",date_breaks="1 hour",date_labels="Nov %d-%H:00")
```
